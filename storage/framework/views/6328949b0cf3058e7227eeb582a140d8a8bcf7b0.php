...
<div class="container">
      <div class="col-sm">
        <div class="card" style="width: 90%;">
            <img src="https://www.superadventure.co.id/uploads/news/2018/10/02/a1207708c16d.jpg" class="card-img-top" alt="gambar laptop">
            <div class="card-body">
              <h5 class="card-title">Kopi Arabika</h5>
              <p class="card-text">Kopi arabika ini adalah kopi pertama yang ditemukan oleh bangsa Arab di Ethiopia. Karena bangsa Arab yang menemukan dan menyebarluaskan ke seluruh dunia maka kopi ini dinamakan kopi arabika.
...
Bourbon, varietas kopi ini ada karena kopi arabika yang dibawa oleh orang Perancis dan ditanam di Pulau Bourbon, sekarang pulau ini bernama Pulau La Reunion. Karena kopi ini beradaptasi dengan tanah di Pulau Bourbon, ia mengalami mutasi dan menjadi varietas kopi bourbon.</p>
            </div>
          </div>
      </div>
      <div class="col-sm">
        <div class="card" style="width: 90%;">
            <img src="https://i0.wp.com/rimbakita.com/wp-content/uploads/2019/03/biji-kopi-robusta.jpg" class="card-img-top" alt="gambar">
            <div class="card-body">
              <h5 class="card-title">Kopi Robusta</h5>
              <p class="card-text">Kopi robusta ini adalah varietas dari kopi canephora. Selain robusta, varietas dari canephora ini adalah kopi nganda. Karena sebagian besar kopi canephora adalah varietas kopi robusta maka nama kopi robusta ini digunakan secara umum untuk kopi canephora.
...
Catimor, varietas kopi dari persilangan antara caturra dan timor. Varietas persilangan ini bertujuan untuk menghasilkan kopi dengan daya tahan hama seperti timor dan kecepatan panen seperti caturra. Karena timor memiliki rasa robusta, jadi catimor ini memiliki rasa pahit tapi tingkat keasamannya rendah.</p>
            </div>
          </div>
      </div>
        <div class="col-sm">
          <div class="card" style="width: 90%;">
              <img src="https://1.bp.blogspot.com/-1tFanWxVfOM/W2giM8fiduI/AAAAAAAAALI/g7UpbxrrK_UX9SJwmYnHRQkrCQ3x7sZ7QCLcBGAs/s1600/Screenshot_134-compressed.jpg" class="card-img-top" alt="gambar">
              <div class="card-body">
              <h5 class="card-title">Kopi Liberika</h5>
                <p class="card-text">Kopi liberika ini memiliki ukuran lebih besar daripada kopi arabika dan kopi robusta. Namun, setelah selesai dengan proses penjemuran, berat buah kering pada kopi ini hanya 10% dari buah basahnya.
...
Pada awalnya kopi liberika ini memiliki nama kopi excelsa yang hanya ada satu spesies. Namun pada tahun 2006 excelsa diresmikan sebagai subspesies dari liberika dan dikenal dengan nama ilmiah coffea liberica var. Dewwrei.</p>
            </div>
        </div>
      </div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\blog-coffee\resources\views/index.blade.php ENDPATH**/ ?>